...
4. **[Education Loan](/services/education-loan) (Global Studies)**: Student Passport, Foreign University Admission Letter, Cost of Attendance Schedule, Co-Applicant Financials, Collateral Documents (Secured).
...
- **GitHub Remote:** `https://github.com/avani-loan-services/avani-loan-services.git`
- **Branch:** `main`
- **Deployment Platform:** Vercel (Production deployment connected to `main`)
